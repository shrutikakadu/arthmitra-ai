...
def _evaluate_scheme(s: dict, profile: dict):
...
def match_user_schemes(profile: dict) -> dict:
    ...
    Implemented using MapReduce pattern via ThreadPoolExecutor.
    """
    ...
    # Map Phase: Distribute scheme evaluation across worker threads
    with ThreadPoolExecutor(max_workers=4) as executor:
        futures = {executor.submit(_evaluate_scheme, s, profile): s for s in schemes}
        
        # Reduce Phase: Collect and aggregate valid results
