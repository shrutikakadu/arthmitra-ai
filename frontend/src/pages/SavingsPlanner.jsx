      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "40px 24px", width: "100%", boxSizing: "border-box" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 36 }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(59, 130, 246, 0.08)", border: "1px solid rgba(59, 130, 246, 0.2)", padding: "4px 14px", borderRadius: 20, color: "#2563eb", fontSize: 13, fontWeight: 600, marginBottom: 12 }}>
            🐷 Micro-Savings & Investment Planner
          </div>
          <h1 style={{ fontSize: "36px", fontWeight: 800, color: "#0f172a", margin: "0 0 10px 0" }}>
            Personalised <span style={{ color: "#2563eb" }}>Government Micro-Savings</span>
          </h1>
          <p style={{ fontSize: "16px", color: "#64748b", maxWidth: 600, margin: "0 auto" }}>
            Secure your family's future with Post Office RD, Jan Dhan SIPs, and Kisan Vikas Patra tailored to your monthly capacity.
          </p>
        </div>

        {loading ? (
          <Loader text="Calculating Micro-Savings Capacity & Returns..." />
        ) : data ? (
          <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
              <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 12, padding: "20px" }}>
                <div style={{ fontSize: 13, color: "#64748b", fontWeight: 500 }}>Monthly Savings Capacity</div>
                <div style={{ fontSize: 28, fontWeight: 800, color: "#138808", marginTop: 4 }}>
                  ₹{data.monthly_savings_capacity?.toLocaleString()} <span style={{ fontSize: 13, color: "#64748b" }}>/mo</span>
                </div>
              </div>

              <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 12, padding: "20px" }}>
                <div style={{ fontSize: 13, color: "#64748b", fontWeight: 500 }}>Total Recommended Commitment</div>
                <div style={{ fontSize: 28, fontWeight: 800, color: "#ff6b00", marginTop: 4 }}>
                  ₹{data.total_monthly_commitment?.toLocaleString()} <span style={{ fontSize: 13, color: "#64748b" }}>/mo</span>
                </div>
              </div>

              <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 12, padding: "20px" }}>
                <div style={{ fontSize: 13, color: "#64748b", fontWeight: 500 }}>Top Recommended Plan</div>
            ...
            <h3 style={{ fontSize: "20px", fontWeight: 800, color: "#0f172a", margin: "12px 0 0 0" }}>Recommended Savings Instruments</h3>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 20 }}>
              {(data.plans || []).map((plan, idx) => (
                <div key={idx} style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 14, padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                  <div>
                    <div style={{ display: "flex", alignItems: "center", justifyBetween: "space-between", gap: 10, marginBottom: 8 }}>
                  ...
                  <div style={{ background: "#fafaf8", border: "1px solid #f1f5f9", borderRadius: 8, padding: "10px", fontSize: 12, color: "#334155" }}>
                    💡 <strong>How to Open:</strong> {plan.how_to}
                  </div>
                </div>
              ))}
            </div>
