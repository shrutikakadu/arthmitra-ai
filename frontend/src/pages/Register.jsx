      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          ...
          <p style={{ color: "#9ca3af", fontSize: "14px", margin: 0 }}>
            Join ArthMitra AI to find welfare schemes you are eligible for
          </p>
        </div>
        ...
        <form onSubmit={handleRegister}>
          ...
          <div style={{ marginBottom: "16px" }}>
            ...
            >
              {STATES.map((s) => (
                <option key={s} value={s} style={{ background: "#0d1a12", color: "#ffffff" }}>
                  {s}
                </option>
              ))}
            </select>
          ...
          <button
            ...
            style={{
              width: "100%",
              padding: "13px",
              background: loading ? "#2e7d32" : "linear-gradient(90deg, #ff6b00 0%, #f97316 100%)",
              color: "#ffffff",
              border: "none",
              borderRadius: "10px",
              fontSize: "15px",
