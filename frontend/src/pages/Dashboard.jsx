      ...
      <div className="animate-in">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: "1.25rem", marginBottom: "1.25rem" }}>
          ...
          <div className="dash-card">
            ...
            <div style={{ width: '100%', height: 280, minHeight: 250, position: 'relative' }}>
          ...
          <div className="dash-card" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <div style={{ width: '100%', height: 200, minHeight: 180, position: 'relative' }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem" }}>
          ...
          <div className="dash-card">
            ...
            <div style={{ width: '100%', height: 220, minHeight: 200, display: 'flex', alignItems: 'center' }}>
              <ResponsiveContainer width="50%" height="100%" minWidth={100} minHeight={160}>
                <PieChart>
