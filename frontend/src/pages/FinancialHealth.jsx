      ...
      <div style={{ background: "#f8fafc", minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        <div style={{ background: "linear-gradient(135deg, #0b192c 0%, #1e293b 100%)", color: "#ffffff", padding: "50px 24px", textAlign: "center" }}>
          <div style={{ maxWidth: 900, margin: "0 auto" }}>
            ...
            <h1 style={{ fontSize: "36px", fontWeight: 900, marginBottom: 10 }}>
              {t("health_vis_title_1")}<span style={{ color: "#4ade80" }}>{t("health_vis_title_hl")}</span>{t("health_vis_title_2")}
            </h1>
            <p style={{ fontSize: "16px", color: "#94a3b8", maxWidth: 650, margin: "0 auto", lineHeight: 1.6 }}>
              {t("health_vis_subtitle")}
            </p>
          </div>
        </div>
        ...
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 24px", flex: 1, width: "100%", boxSizing: "border-box" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: 32, alignItems: "start", marginBottom: 40 }}>
            ...
            <div style={{ background: "#ffffff", border: "1px solid #cbd5e1", borderRadius: 20, padding: "32px 24px", textAlign: "center", boxShadow: "0 4px 20px rgba(0,0,0,0.04)" }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: "#ef4444", background: "#fef2f2", border: "1px solid #fca5a5", padding: "4px 12px", borderRadius: 20, textTransform: "uppercase", letterSpacing: "0.05em" }}>
                {t("health_vis_sample_badge")}
              </span>
              <div style={{ margin: "24px 0 16px 0" }}>
                <ScoreGauge score={78} grade="B+" label={t("health_standing_good")} />
              </div>
              <h3 style={{ fontSize: "28px", fontWeight: 900, color: "#0f172a", margin: "8px 0 4px 0" }}>{t("health_vis_sample_title")}</h3>
              <p style={{ fontSize: 14, color: "#166534", fontWeight: 700, background: "#f0fdf4", display: "inline-block", padding: "4px 14px", borderRadius: 12 }}>
                {t("health_vis_sample_status")}
              </p>
              <p style={{ fontSize: 13, color: "#64748b", marginTop: 14, lineHeight: 1.5 }}>
                {t("health_vis_sample_desc")}
              </p>
            </div>
            ...
            <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 20, padding: "28px", boxShadow: "0 4px 20px rgba(0,0,0,0.03)" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: 15, fontWeight: 700, color: "#0f172a", margin: 0 }}>{t("health_vis_pillar1_title")}</h4>
                    <p style={{ fontSize: 13, color: "#64748b", margin: "2px 0 0 0", lineHeight: 1.4 }}>{t("health_vis_pillar1_desc")}</p>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: 15, fontWeight: 700, color: "#0f172a", margin: 0 }}>{t("health_vis_pillar2_title")}</h4>
                    <p style={{ fontSize: 13, color: "#64748b", margin: "2px 0 0 0", lineHeight: 1.4 }}>{t("health_vis_pillar2_desc")}</p>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: 15, fontWeight: 700, color: "#0f172a", margin: 0 }}>{t("health_vis_pillar3_title")}</h4>
                    <p style={{ fontSize: 13, color: "#64748b", margin: "2px 0 0 0", lineHeight: 1.4 }}>{t("health_vis_pillar3_desc")}</p>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: 15, fontWeight: 700, color: "#0f172a", margin: 0 }}>{t("health_vis_pillar4_title")}</h4>
                    <p style={{ fontSize: 13, color: "#64748b", margin: "2px 0 0 0", lineHeight: 1.4 }}>{t("health_vis_pillar4_desc")}</p>
                  </div>
                </div>
                ...
                <div style={{ display: "flex", gap: 14, alignItems: "flex-start" }}>
                  ...
                  <div>
                    <h4 style={{ fontSize: 15, fontWeight: 700, color: "#0f172a", margin: 0 }}>{t("health_vis_pillar5_title")}</h4>
                    <p style={{ fontSize: 13, color: "#64748b", margin: "2px 0 0 0", lineHeight: 1.4 }}>{t("health_vis_pillar5_desc")}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div style={{ background: "linear-gradient(90deg, #138808 0%, #059669 100%)", color: "#ffffff", padding: "36px 28px", borderRadius: 16, textAlign: "center" }}>
            <h3 style={{ fontSize: "24px", fontWeight: 800, marginBottom: 8 }}>{t("health_vis_cta_title")}</h3>
            <p style={{ fontSize: 15, color: "rgba(255,255,255,0.9)", maxWidth: 600, margin: "0 auto 20px auto" }}>
              {t("health_vis_cta_desc")}
            </p>
            <Link
              to="/login"
              style={{
                  ...
                  {Object.entries(data.dimensions || {}).map(([key, dim]) => (
                    <div key={key}>
                      <div style={{ display: "flex", justifyContent: "space-between", fontSize: 13, color: "#334155", marginBottom: 4 }}>
                        <span style={{ fontWeight: 600 }}>{t("dim_" + key) || dim.label}</span>
                    ...
                    {data.roadmap.map((item, idx) => (
                      <div key={idx} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px", borderRadius: 8, border: "1px solid #f1f5f9", background: "#fafaf8" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                          <span style={{ fontSize: 11, fontWeight: 700, padding: "2px 8px", borderRadius: 4, background: item.priority === "HIGH" ? "#fef2f2" : "#f0fdf4", color: item.priority === "HIGH" ? "#ef4444" : "#166534" }}>{t("priority_" + (item.priority || "high").toLowerCase()) || item.priority}</span>
